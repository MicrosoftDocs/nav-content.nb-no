...
## <a name="define-a-mailing-group-code"></a>Definere en postgruppekode
...
1. I øvre høyre hjørne velger du ikonet **Søk etter side eller rapport**, angir **Postgrupper** og velger deretter den relaterte koblingen.
...
## <a name="assign-mailing-groups-to-a-contact"></a>Tiordne postgrupper til en kontakt
1. Åpne kontakten.
